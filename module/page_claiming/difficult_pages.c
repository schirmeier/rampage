...
/**
 * Ignore pages that are known to be "untestable". Touching certain pages may
 * lead to kernel crashes or other undesirable effects. This implementation
 * ABORTs the freeing process for these pages.
 */
                           ...
                           unsigned long* actual_source)
{
	...
	/* 
	 * FIXME: page_to_phys liefert eine Adresse, d.h. der Ausdruck testet
	 * ob requested_page unter Adresse 0x400 anfängt!
	 */

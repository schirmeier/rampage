...
//  try_claim_method try_claim_methods[]  =  {try_claim_free_page,try_claim_free_buddy_page,try_claim_page_in_page_cache,try_claim_page_from_user_process, ignore_difficult_pages, NULL};
//  try_claim_method try_claim_methods[]  =  {try_claim_free_buddy_page,NULL};
//  try_claim_method try_claim_methods[]  =  {ignore_difficult_pages, try_any_page_claiming, NULL};
